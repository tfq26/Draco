  ...
  <div class="auth-card-container">
    <div class="auth-card">
      <div class="card-header">
        <h2 class="auth-title">Register Identity</h2>
        <p class="auth-sub">Sign up for Draco to help you manage and monitor your cloud resources.</p>
      </div>

      <div class="auth-body">
        <div class="input-group">
          <label for="name">Operator Alias</label>
          <input 
            id="name"
            v-model="name" 
            type="text" 
        ...
        <div class="input-group">
          <label for="email">Access Point (Email)</label>
          <input 
            id="email"
            v-model="email" 
            type="email" 
        ...
        <div class="auth-actions">
          <button @click="handleSignUp" class="primary-btn wide" :disabled="isLoading || !email || !password || !name">
...
<style scoped>
/* Reuse styles from SignIn.vue for consistency */
.auth-card-container {
  display: flex;
